...
CODE_REPO_METRIC_TO_AIMRI: Dict[str, List[Dict[str, str]]] = {
    ...
    "fs.deployment_maturity": [
        ...
        {"dimension": "9. Foundation Model Operations", "subsection": "9.3 Performance Optimization"},
    ],
    "fs.experiment_org": [
    ...
    "infra.model_export": [
        ...
        {"dimension": "2. Data Management & Quality",   "subsection": "2.4 Data Operations"},
    ],
    "infra.data_pipeline": [
        {"dimension": "2. Data Management & Quality",   "subsection": "2.2 Data Quality"},
    ...
    "infra.feature_engineering": [
        {"dimension": "1. Technical Infrastructure",    "subsection": "1.5 Security Infrastructure"},
        {"dimension": "5. Governance & Ethics",         "subsection": "5.2 Regulatory Compliance"},
        {"dimension": "11. Responsible AI & Social Impact", "subsection": "11.2 Privacy & Data Protection"},
