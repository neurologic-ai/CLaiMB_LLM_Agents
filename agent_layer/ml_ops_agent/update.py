...
from agent_layer.ml_ops_agent.map_db import AimriData
...
logger.add(f"{LOG_DIR}/ml_ops_mapping_update.log", rotation="10 MB", retention="10 days", level="INFO")
...
def save_mapping_to_file(mapping: Dict[str, List[Dict[str, str]]]) -> None:
    file_path = r'agent_layer\ml_ops_agent\aimri_mapping.py'
