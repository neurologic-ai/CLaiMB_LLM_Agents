...
ML_OPS_METRIC_TO_AIMRI: Dict[str, List[dict]] = {
    ...
    "aml.cost_correlation_band": [
        {"dimension": "12. AI Business Value & ROI", "subsection": "12.2 Cost Reduction & Efficiency"},
        {"dimension": "1.2", "subsection": "01. Technical Infrastructure"},
        {"dimension": "3.3", "subsection": "03. AI/ML Capabilities"},
        {"dimension": "8.5", "subsection": "08. Process Maturity"}
    ],
